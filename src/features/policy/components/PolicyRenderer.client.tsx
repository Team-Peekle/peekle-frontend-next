...
const PolicyRenderer = ({ termsType }: PolicyRendererProps) => {
  const content = {
    [TermsType.PRIVACY]: `
## 제1조(목적)
주식회사 '히나'(이하 '회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 '회사 서비스')를 이용하는 개인(이하 '이용자' 또는 '개인')의 정보(이하 '개인정보')를 보호하기 위해, 개인정보보호법, 정보통신망 이용촉진 및 정보보호 등에 관한 법률(이하 '정보통신망법') 등 관련 법령을 준수하고, 서비스 이용자의 개인정보 보호 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침(이하 '본 방침')을 수립합니다.

## 제2조(개인정보 처리의 원칙)
개인정보 관련 법령 및 본 방침에 따라 회사는 이용자의 개인정보를 수립할 수 있으며 수집된 개인정보는 개인의 동의가 있는 경우에 한하여 제 3자에게 제공될 수 있습니다. 단, 법령의 규정 등에 의해 적법하게 강제되는 경우 회사는 수집한 이용자의 개인정보를 사전에 개인의 동의 없이 제3자에게 제공할 수 있습니다.

## 제3조(본 방침의 공개)
1. 회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 첫 화면과의 연결화면을 통하여 방침을 공개하고 있습니다.
2. 회사는 개정에 따라 본 방침을 공개하는 경우 생성 일자, 개정 등을 활용하여 이용자가 본 방침을 쉽게 확인할 수 있도록 합니다.

## 제4조(본 방침의 변경)
1. 본 방침은 관련 법령 관련 법령, 지침, 고시 또는 정체나 회사 서비스의 체계나 내용의 변경에 따라 개정될 수 있습니다.
...
1. 필수 수집 정보: 이름, 닉네임, 생년월일 및 휴대폰 번호
2. 선택 수집 정보: 프로필 사진

## 제6조(본인 인증을 위한 정보)
회사는 이용자의 본인인증을 위하여 다음과 같은 정보를 수집합니다.
1. 필수 수집 정보: 휴대폰 번호, 이름, 생년월일, 성별, 본인확인값(CI, DI) 및 이용통신사

## 제7조(회사 서비스 제공을 위한 정보)
회사는 이용자에게 회사의 서비스를 제공하기 위하여 다음과 같은 정보를 수집합니다.
1. 필수 수집 정보: 아이디, 이름, 생년월일 및 연락처

## 제8조(서비스 이용 및 부정 이용 확인을 위한 정보)
회사는 이용자의 서비스 이용 내역(방문 일시 및 부정이용의 확인 및 내용 분석을 위하여 다음과 같은 정보를 수집합니다. (부정이용이란 이용약관 제 12조(등), 이용 우회 및 우회 시도 등을 반복적으로 행하는 등 회사가 제공하는 할인혜택, 이벤트 혜택 등의 경제적 이익을 불법적 등으로 취득하는 행위, 이용약관 등에서 금지하고 있는 행위, 명의도용 등의 불법행위 등을 말합니다.)
1. 필수 수집 정보: 서비스 이용기록, 쿠키, 접속지 정보 및 기기정보

## 제9조(개인정보 수집 방법)
회사는 다음과 같은 본 방침 하에 이용자의 개인정보를 수집합니다.
1. 이용자가 회사의 홈페이지에서 자신의 개인정보를 입력하는 방식
2. 어플리케이션 등 회사가 제공하는 홈페이지 이외의 서비스를 통하여 이용자가 자신의 개인정보를 입력하는 방식
3. 이용자가 고객센터의 상담, 게시판에서의 활동 등 회사의 서비스를 이용하는 과정에서 이용자가 입력하는 방식

## 제10조(개인정보의 이용)
회사는 개인정보를 다음 각 호의 범위 내 이용합니다.
1. 공지사항의 전달 등 회사운영의 필요한 경우
2. 이용문의에 대한 회신, 불만의 처리 등 이용자에 대한 서비스 개선을 위한 경우
3. 회사의 서비스를 최소한의 범위 내 운영하는 경우
4. 법령 및 회사 약관을 위반하는 이용자에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 처분을 위한 경우
5. 신규 서비스 개발을 위한 경우
6. 인구학적 분석, 서비스 방문 및 이용기록의 분석을 위한 경우
7. 개인정보 및 관심에 기반한 이용자 간 관계의 형성을 위한 경우

## 제11조(개인정보의 보유 및 이용기간)
1. 회사는 이용자의 개인정보(휴대폰 번호 개인정보의 수집·이용 목적 달성 시를 보관 기간 동안 개인정보를 보유 및 이용합니다.
2. 전항에도 불구하고 회사는 내부 방침에 의해 서비스 부정이용기록은 부정 가입 및 이용방지를 위하여 회원 탈퇴 시점으로부터 최대 1년 간 보관합니다.

## 제12조(법령에 따른 개인정보의 보유 및 이용기간)
회사는 관계법령에 따라 다음과 같이 개인정보를 보유 및 이용합니다.
1. 전자상거래 등에서의 소비자보호에 관한 법률에 따른 보관정보 및 보관 기간
- 가. 계약 또는 청약철회 등에 관한 기록: 5년
- 나. 대금결제 및 재화 등의 공급에 관한 기록: 5년
- 다. 소비자의 불만 또는 분쟁처리에 관한 기록: 3년
- 라. 표시·광고에 관한 기록: 6개월
2. 통신비밀보호법에 따른 보관정보 및 보관기간
- 가. 웹사이트 로그 기록 자료: 3개월
3. 전자금융거래법에 따른 보관정보 및 보관기간
- 가. 전자금융거래에 관한 기록: 5년
4. 부가가치세법 보호 및 이용 등에 관한 법률
- 가. 개인지급정보에 관한 기록: 10년

## 제13조(개인정보의 파기절차)
회사는 원칙적으로 이용자의 개인정보 처리 목적의 달성, 보유·이용기간의 경과 등 개인정보가 필요하지 않게 될 경우에는 해당 정보를 지체 없이 파기합니다.

## 제14조(개인정보 파기절차)
1. 이용자가 회원가입 등을 위해 입력한 정보는 개인정보 처리 목적이 달성된 후 별도의 DB에 옮겨져(종이의 경우 별도의 서류함) 내부 방침 및 기타 관련 법령에 의한 정보 보호 사유에 따라(보유 및 이용기간 참조) 일정 기간 저장된 후 파기되어 집니다.
...
## 제16조(광고성 정보의 전송 조제)
1. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 이용자의 명시적인 사전에 동의를 얻습니다. 다만, 다음 각 호 어느 하나에 해당하는 경우에는 사전 동의를 얻지 않습니다.
...
- 나. 방문판매 등에 관한 법률에 따른 전화권유판매자가 육성으로 수신자에게 직접전화하여 수집출처를 고지하고 전화권유를 하는 경우
2. 회사는 전자적 전송매체를 이용하여 수신자에게 정보를 표시하거나 내신 통화를 참여한 경우에는 영리목적의 광고성 정보를 전송하지 않으며 수신 거부 및 수신동의 철회에 대하여 비용을 발생시키지 않습니다.
3. 회사는 오후 9시부터 그다음 날 오전 8시까지의 시간에 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우에는 제1항에도 불구하고 그 수신자로부터 별도의 사전 동의를 받습니다.
4. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음 각 항의 정보를 광고성 정보에 구체적으로 밝힙니다.
- 가. 회사명 및 연락처
- 나. 수신 거부 또는 수신 동의의 철회 의사의 표현에 관한 사항의 표시
5. 회사는 전자적 전송매체를 이용하여 영리목적의 광고성 정보를 전송하는 경우 다음 각 호의 어느 하나에 해당하는 조치를 하지 않습니다.
- 가. 광고성 정보 수신자의 수신거부 또는 수신동의 철회를 회피·방해하는 조치
- 나. 광고성 정보를 전송할 때 부호·문자 또는 영상을 사용하여 수신자의 연락처를 자동적으로 만들어 내는 조치
- 다. 영리목적의 광고성 정보를 전송할 때 전화번호나 연락처를 얻는 전자우편주소를 자동 수집 중복하는 조치
- 라. 광고성 정보 전송자의 신원이나 광고 전송 출처를 속이기 위한 대리 조치
- 마. 영리목적의 광고성 정보를 전송할 목적으로 수신자를 가장하여 회신을 유도하는 다른 조치
...
회사는 개인정보의 분실·도난·유출(이하 "유출 등"이라 한다) 사실을 안 때에는 지체없이 다음 각 호의 모든 사항을 해당 이용자에게 알리고 방송통신위원회 또는 한국인터넷진흥원에 신고합니다.
1. 유출 등이 된 개인정보 항목
2. 유출 등이 발생한 시점
3. 이용자가 취할 수 있는 조치
...
1. 회사는 이용자에게 개별적인 맞춤서비스를 제공하기 위해 이용 정보를 저장하고 수시로 불러오는 개인정보 자동 수집장치(이하 '쿠키')를 사용합니다. 쿠키는 웹사이트를 운영하는데 이용되는 서버(http)가 이용자의 웹브라우저(PC 및 모바일 등 포함)에 보내는 소량의 정보이며 이용자의 직접저장장치(하드디스크 등)에 저장됩니다.
...
## 제22조(권익침해에 대한 구제방법)
1. 정보주체는 개인정보침해에 대한 구제를 받기 위하여 개인정보분쟁조정위원회, 한국인터넷진흥원 개인정보침해신고센터 등에 분쟁해결이나 상담 등을 신청할 수 있습니다. 이 밖에 기타 개인정보침해의 신고, 상담에 대하여는 아래의 기관에 문의하시기 바랍니다.
- 가. 개인정보분쟁조정위원회: (국번없이) 1833-6972 (www.kopico.go.kr)
- 나. 개인정보침해신고센터: (국번없이) 118 (privacy.kisa.or.kr)
- 다. 대검찰청: (국번없이) 1301 (www.spo.go.kr)
- 라. 경찰청: (국번없이) 182 (ecrm.cyber.go.kr)
2. 회사는 정보주체의 개인정보자기결정권을 보장하고, 개인정보 침해로 인한 상담 및 피해 구제를 위해 노력하고 있으며, 신고나 상담이 필요한 경우 제 18조의 연락처로 연락해 주시기 바랍니다.
...
## 부칙
본 방침은 공지일 2023.02.16.부터 시행됩니다.
`,
    [TermsType.TERMS]: `
## 제1조(목적)
이 약관은 주식회사 '히나'(이하 '회사'라 함)가 제공하는 서비스 및 이와 관련된 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.

## 제2조(정의)
이 약관에서 사용하는 용어의 정의는 다음과 같습니다.
1. '서비스'라 함은 단말기(PC, 휴대형 단말기 등의 각종 유무선 장치를 포함)와 상관없이 이용자가 이용할 수 있는 회사 서비스를 의미합니다.
2. '이용자'란 회사의 서비스에 접속하여 이 약관에 따라 회사가 제공하는 서비스를 이용하는 고객을 말합니다.
...
5. '비밀번호'라 함은 회원이 부여받은 아이디와 일치되는 회원임을 확인하고 비밀보호를 위해 회원 자신이 정한 문자 또는 숫자의 조합을 의미합니다.
6. '게시물'이라 함은 회원이 서비스를 이용함에 있어 서비스상에 게시한 부호·문자·음성·음향·화상·동영상 등의 정보 형태의 글, 사진, 동영상 및 각종 파일과 링크 등을 의미합니다.
...
## 제4조(약관의 해석)
1. 회사는 서비스 운영을 위해 필요한 경우 개별 서비스에 대하여 별도의 이용약관 및 정책(이하 '별도 약관 등')을 둘 수 있으며, 해당 내용이 이 약관과 상충할 경우에는 '별도 약관 등'이 우선하여 적용됩니다.
2. 이 약관에서 정하지 아니한 사항이나 해석에 대해서는 '별도 약관 등' 및 관련법령 또는 상관례에 따릅니다.
...
## 제9조(회원에 대한 통지)
1. 회사가 회원에 대한 통지를 하는 경우 이 약관에 별도 규정이 없는 한 서비스 내 전자우편주소, 전자메모 등으로 할 수 있습니다.
...
## 제15조(게시물의 저작권)
1. 회원이 서비스 내에 게시한 게시물의 저작권은 해당 게시물의 저자에게 귀속됩니다.
2. 회원은 서비스를 이용하면서 얻은 정보를 회사의 사전 승낙 없이 복제, 송신, 출판, 배포, 방송 기타 방법에 의하여 영리목적으로 이용하거나 제3자에게 이용하게 하여서는 안 됩니다.
...
## 제18조(이용제한 등)
1. 회사는 회원이 이 약관의 의무를 위반하거나 서비스의 정상적인 운영을 방해하는 경우, 경고, 일시정지, 영구이용정지 등으로 서비스 이용을 단계적으로 제한할 수 있습니다.
  ...
  return (
    <main className="py-100pxr px-16pxr">
      <article>
        ...
        >
          {content[termsType] ?? ErrorContent}
        </ReactMarkdown>
      </article>
    </main>
  );
